...
<div class="nav-side-menu">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <ul class="sub-menu collapse" id="new">
                 ...
                 <li>
                  ...
                  <li>
                  <a href="<?php echo URL?>addlibrarian/view">
                  <i class="fa fa-user fa-lg"></i> Add Librarian
                  </a>
                  </li>

                 <li>
                  <a href="<?php echo URL?>Reserved/view">
                  <i class="fa fa-users fa-lg"></i> Pending Reservation
                  </a>
                </li>
            </ul>
     </div>
 ...
 <!--  <center><h1 style="margin:0;">Dewey Decimal System</h1></center> -->
    ...
    <div class="col-md-7" style="height:180px;padding:500">
    <div class="thumbnail">
           ...
           <li class="message-preview">
                        ...
                        <br />  
   <center>
   <p><a class=" img-circle btn btn-primary" role="button">View This Book</a> <a class=" img-circle btn btn-primary" role="button">Reject</a></p>
   <p> </p>
 ...
 <div class="col-md-7" style="height:180px;padding:500">
    <div class="thumbnail">
           ...
           <li class="message-preview">
                        ...
                        <br />  
   <center>
   <p><a class=" img-circle btn btn-primary" role="button">Accept </a> <a class=" img-circle btn btn-primary" role="button">Reject</a></p>
   <p> </p>
