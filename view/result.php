 ...
 <tr>
  ...
  <div class="col-md-11"  style="background-color:#f6f6f6;">
        ...
        <div class="col-md-6">
          ...
          <span style="color:gray;"><span style="color:blue;font-weight:bold">Author: </span><?php echo result_model::getauthor($value['author']); ?></span><br>
        ...
        <div class="col-md-3 " >
        <span style="color:gray;"><span style="color:orange;"><b>Available copies: </b></span> <?php echo result_model::countbookavailable($value['bid'])-result_model::countbookborrow($value['bid']); ?></span><br>
